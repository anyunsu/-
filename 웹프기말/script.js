function searchTeam() {
    ...
    var teamData = {
        ...
        '밀란': 'AC 밀란도 세계적으로 유명한 클럽이고 과거에는 레알 마드리드 못지 않은 클럽이였습니다.',
        '인테르': '인테르는 이탈리아 클럽 최초이자 유일무이한 트레블을 달성한 명문 클럽입니다 유명스타로는 사네티가 있습니다.',
        '도르트문트': '도르트문트는 이영표,지동원,박주호 한국선수들이 뛴 클럽이기도 하고 응원으로도 유명한 클럽입니다.',
        ...
        '토트넘': '이영표 선수가 토트넘에서 선수 생활을 했고 손흥민 선수가 현역으로도 뛰고 있으며 매우 잘하면서 우리나라 팬이 매우 많습니다.',
        '슈투트가르트': '흔히 말하는 작은 정우영 선수가 뛰고 있으며 뮌헨에서 데뷔를 했으며 이번 아시안게임에서 득점왕을 하며 유명해졌습니다.',
        '미트윌란': '카타르 월드컵에서 스타가된 조규성 선수가 이번시즌 이적을 하면서 한국사람들에게 알려지기 시작했습니다 그리고 이한범 선수도 이적을 하기도 했습니다.',
    };
